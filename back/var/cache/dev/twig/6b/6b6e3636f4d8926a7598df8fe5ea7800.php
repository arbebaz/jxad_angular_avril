...
class __TwigTemplate_5b511d32ddef733131da78ac6b60018b extends Template
{
    private $source;
    private $macros = [];
...
\t\t<h1 class=\"text-center\">Hello Contact 📨</h1>
...
\t\t\t";
        // line 18
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 18, $this->source); })()), "message", [], "any", false, false, false, 18), 'row');
        echo "
...
\t\t<p class=\"fst-italic\">** Cette option est disponible avec un profil Artiste.
\t\t\t<br>
\t\t\tPour bénéficier de ce profil, envoyez-nous un message.
\t\t\t<br>
\t\t\tMerci, l'équipe JXAD Musique. 🦋</p>
...
";
    ...
    {
        return array (  124 => 36,  121 => 35,  116 => 21,  110 => 18,  104 => 15,  100 => 14,  95 => 12,  87 => 6,  77 => 5,  59 => 3,  36 => 1,);
    }
...
\t\t\t\t\t\t\t\t\t\t\t\t\t{{ form_row(form.file) }}
\t\t\t\t\t\t\t\t\t\t\t\t\t<p>Pour envoyer un fichier audio ou video, veuillez compresser votre fichier s'il vous plait.</p>
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t{% else %}
\t\t\t\t\t\t\t\t\t\t\t\t\t<p class=\"fw-bold fst-italic\">Pour envoyer un fichier vous devez posséder un profil artiste.
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<br>
\t\t\t\t\t\t\t\t\t\t\t\t\t\tPour avoir ce profil, envoyez-nous un message avec en sujet : Profil Artiste.
\t\t\t\t\t\t\t\t\t\t\t\t\t\t<br>
\t\t\t\t\t\t\t\t\t\t\t\t\t\tMerci, l'équipe JXAD Musique.</p>
\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t\t\t\t{% endif %} #}
...
{% endblock %}
", "contact/index.html.twig", "/Users/abeba/Desktop/jxadMusic/templates/contact/index.html.twig");
    }
}
